# Dimension_Reduction_Feature_Selection_Hotel_Dataset
This project involves comparing dimension reduction and feature selection methods on hotel reservation data.  <br><br>
## About Dataset
### Context 
